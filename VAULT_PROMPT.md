...
## What to write
1. **Journal entry** — `journal/YYYY-MM-DD-chore-tritonjit.md` (today's date). Include:
   ...
   - Link to the branch: `chore/tritonjit`, commit hashes
...
- Vault paths: the Obsidian vault root differs from the git repo; address
  ...
  `journal/2026-08-11-chore-tritonjit.md`). If unsure, `obsidian_search_notes`
